(function ($) {
    $(document).ready(function () {
        let body = 'body';
        let feedback_modal = '#ai-buddy-feedback-modal';
        ...
        $(body).on('click', '.feedback-submit', function (e) {
            ...
            $.ajax({
                ...
                beforeSend: function (xhr) {
                    xhr.setRequestHeader('X-WP-Nonce', ai_buddy_localized_data.ai_buddy_feedback.nonce);
                },
    ...
    function set_stars() {
        $('ul#feedback-stars li i').css('background-image', 'url(' + ai_buddy_localized_data.ai_buddy_feedback.plugin_url + '/assets/images/feedback-star.svg)');
        $('ul#feedback-stars li.selected i').css('background-image', 'url(' + ai_buddy_localized_data.ai_buddy_feedback.plugin_url + '/assets/images/feedback-star-filled.svg)');
    }
})(jQuery);
